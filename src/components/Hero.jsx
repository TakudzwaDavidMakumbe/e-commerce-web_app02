    ...
    <div className='container pt-8'>
        <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
            <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                <img src="/hero__1.webp" alt="hero image"
            ...
            <div className="ralative">
                ...
                <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[25%] -translate-y-[25%] sm:space-y-0">
            ...
            <div className="ralative">
                ...
                <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[70%] -translate-y-[50%] sm:space-y-0">
